<template>
  <div class="vajra padding">
    <div class="">
      <div class="text-main text-xl border-bottom-seat padding-bottom-sm margin-bottom-sm">金刚区</div>
  ...
  .content-list{
    .list-line{display: flex;align-items: center;
      ...
      .right-opt{display:flex;align-items: center;flex-grow:1;
        .line-image{width:30px;height:30px;flex-shrink:0;
