    ...
    <content-area contentTitle="站内信模版列表">
      <template slot="control">
        <div style="float:right">
          <el-button size="mini" v-np='"MSG_TIPS_TEMPLATE_PAGE_VIEW"' type="primary" @click="handleToList">查看无模板消息</el-button>
          <el-button size="mini" v-np='"MSG_TIPS_TASK_CREATE"' type="primary" @click="handleAddMessage">新建消息</el-button>
          <el-button size="mini" v-np='"MSG_TIPS_TEMPLATE_CREATE"' type="primary" @click="handleSetting">新建模板</el-button>
        </div>
      </template>
