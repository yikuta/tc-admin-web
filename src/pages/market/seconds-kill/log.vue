<template>
  <div class="app-container">
    ...
    <div class="container">
      <p>场次：{{$route.query.timePeriod}}</p>
      <p>参与商品数：{{$route.query.channelCommodityNum}}</p>
      <p>操作日志</p>
...
export default {
  ...
  methods: {
    handleDataList() {
      reqPromotionLogList({
        identifier: 'seckill_session_' + this.$route.query.seckillSessionCode,
    ...
    handleLink(version) {
      const { seckillSessionCode } = this.$route.query
