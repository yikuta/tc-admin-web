  ...
  <div class="select-dialog">
    ...
    width="85%">
      ...
      <el-form :model="goodsForm" v-else>
        <el-form-item label="">
          <select-goods :form="form" :selected="goodsForm" :options="goodsOptions" :optionProps="goodsOptionProps" @on-select-goods="onSelectGoods"></select-goods>
        </el-form-item>
      </el-form>
