  ...
  <div class="app-container">
    <el-card class="search-content">
      ...
      <div class="search-btn">
        <el-button type="primary" size="mini" @click="hanldeBatch" v-np="'ACTIVITY_FOR_GROUP_BUY_BATCH_AUDIT'">批量处理</el-button>
    ...
    <el-table :data="tableData" size="mini" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="groupBuyActivityName" label="优惠名称"></el-table-column>
      <el-table-column prop="channelCommodityName" label="拼团商品"></el-table-column>
      <el-table-column prop="groupBuyPrice" label="拼团价"></el-table-column>
      ...
      <el-table-column label="操作">
        <template v-slot:default="{ row }">
          <el-link v-show="row.auditStatus.value == 1" :disabled="disabledBtn" type="primary" @click="pass(row)" v-np="'ACTIVITY_FOR_GROUP_BUY_BATCH_PASS'">通过</el-link>
          <el-link v-show="row.auditStatus.value == 1" :disabled="disabledBtn" type="primary" @click="reject(row)" v-np="'ACTIVITY_FOR_GROUP_BUY_BATCH_REJECT'">驳回</el-link>
        </template>
      </el-table-column>
    </el-table>
...
<script>
  ...
  import { reqGroupBuyActivityAuditList, reqOrderActivityBatchAudit, reqUserList } from '@/api/coupon'
  export default {
    name: 'man-made',
    components: {
      Pagination
    ...
    methods: {
      handleSubmit() {
        ...
        this._reqGroupBuyActivityAuditList(req)
      },
      ...
      // ***请求处理***
      _reqGroupBuyActivityAuditList(data) {
        return reqGroupBuyActivityAuditList({
