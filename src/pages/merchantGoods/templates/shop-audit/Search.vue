<template>
  <div class="wrapper">
    <el-form ref="form" :model="form" label-width="120px" inline size="mini">
      ...
      <el-form-item label="商品名称" prop="productName.value">
        <el-input v-model="form.productName.value" placeholder="商品名称" clearable></el-input>
      </el-form-item>
...
export default {
  ...
  data() {
    return {
      form: {
        status: { value: '', name: 'auditStatus', matchType: MatchType.EQUAL, type: DataType.ENUM },
        productName: { value: '', name: 'productName', matchType: MatchType.CONTAIN, type: DataType.STRING },
      ...
      statusOption: [
        { value: '', label: '全部' },
        { value: 'boss.ShopGoodsAuditStaus_12', label: '被驳回' },
        { value: 'boss.ShopGoodsAuditStaus_11', label: '审核通过' }
      ]
    }
  },
  methods: {
