  ...
  <div class="wrapper">
    <el-form ref="form" :model="form" label-width="120px" size="small" class="platform-form">
      <el-row>
        ...
        <el-col :span="5">
          <el-form-item label="所属商家" prop="storeName.value" :label-width="labelWidth">
            <el-input v-model="form.storeName.value" placeholder="所属商家" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
  ...
  data() {
    return {
      ...
      form: {
        ...
        storeName: { value: '', name: 'storeName', matchType: MatchType.CONTAIN, type: DataType.STRING },
        createTime: { value: [], name: 'createTime', matchType: MatchType.BETWEEN, type: DataType.DATE },
        orderType: { value: 'OrderType_3', name: 'orderType', matchType: MatchType.EQUAL, type: DataType.ENUM }
      },
      statusOption: [
        { value: '', label: '全部' },
