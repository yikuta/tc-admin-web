<template>
  <div class="wrapper">
    <el-form ref="form" :model="form" label-width="120px" size="small" class="platform-form">
      <el-row>
        <el-col :span="8">
          <el-form-item label="补发单号" prop="generateNum.value" :label-width="labelWidth">
            <el-input v-model="form.generateNum.value" placeholder="补发单号" clearable style="width:100%"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="5">
        ...
        <el-col :span="6">
          <el-form-item label="补发状态" prop="reshipmentState.value" :label-width="labelWidth">
            <el-select v-model="form.reshipmentState.value" placeholder="请选择" clearable>
  ...
  data() {
    return {
      ...
      form: {
        ...
        reshipmentState: { value: '', name: 'reshipmentState', matchType: MatchType.EQUAL, type: DataType.ENUM },
        ...
        afterSaleChooseTreatmentPlan: { value: 'AfterSaleChooseTreatmentPlan_3', name: 'afterSale.chooseTreatmentPlan', matchType: MatchType.EQUAL, type: DataType.ENUM }
      },
      statusOption: [
        { value: '', label: '全部' },
        { value: 'AfterSaleReshipmentState_1', label: '待审核' },
        { value: 'AfterSaleReshipmentState_2', label: '待补发出库' },
        { value: 'AfterSaleReshipmentState_3', label: '已补发出库' },
        { value: 'AfterSaleReshipmentState_4', label: '审核拒绝' }
      ]
    }
  },
  methods: {
