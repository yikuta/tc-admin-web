<template>
  <div class="wrapper">
    <el-form ref="form" :model="form" label-width="120px" size="small" class="platform-form">
      <el-row>
        <el-col :span="8">
          <el-form-item label="换货单号" prop="generateNum.value" :label-width="labelWidth">
        ...
        <el-col :span="6">
          <el-form-item label="换货状态" prop="exchangeGoodsState.value" :label-width="labelWidth">
            <el-select v-model="form.exchangeGoodsState.value" placeholder="请选择" clearable>
  ...
  data() {
    return {
      ...
      form: {
        ...
        exchangeGoodsState: { value: '', name: 'exchangeGoodsState', matchType: MatchType.EQUAL, type: DataType.ENUM },
        ...
        afterSaleChooseTreatmentPlan: { value: 'AfterSaleChooseTreatmentPlan_5', name: 'afterSale.chooseTreatmentPlan', matchType: MatchType.EQUAL, type: DataType.ENUM }
      },
      statusOption: [
        { value: '', label: '全部' },
        { value: 'AfterSaleExchangeGoodsState_1', label: '待审核' },
        { value: 'AfterSaleExchangeGoodsState_2', label: '待仓库收货' },
        { value: 'AfterSaleExchangeGoodsState_3', label: '收货失败' },
        { value: 'AfterSaleExchangeGoodsState_4', label: '收货成功' },
        { value: 'AfterSaleExchangeGoodsState_5', label: '换货成功' },
        { value: 'AfterSaleExchangeGoodsState_6', label: '审核拒绝' }
      ]
    }
  },
  methods: {
