  ...
  <div style="margin-top: 15px">
    <el-form ref="queryForm" :model="form" label-width="100px" size="mini" class="">
      <el-row>
        ...
        <el-col :span="6">
          <el-form-item :label-width="labelWidth" label="门店编码" prop="skuNo">
            <el-input
        ...
        <el-col :span="5">
          <el-form-item :label-width="labelWidth" label="门店名称" prop="skuName">
            <el-input
...
export default {
  ...
  data() {
    return {
      ...
      name: '',
      form: {
        orderType: { value: 'OrderType_3', name: 'orderType', matchType: MatchType.EQUAL, type: DataType.ENUM }, // 商家自营
        ...
        storeName: { value: '', name: 'orderInfo.storeName', matchType: MatchType.CONTAIN }, // 门店名称
