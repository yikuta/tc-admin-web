...
import { queryShopOrderDeliverys } from '@/api/order'
...
export default {
  ...
  methods: {
    ...
    handleOrderList() {
      ...
      this.loading = true
      // let obj = {
      //   orderType: { value: 'OrderType_2', name: 'orderType', matchType: MatchType.EQUAL, type: DataType.ENUM } // 快递到家
      // }
      // this.queryForm = this.queryForm.concat(searchTool(obj))
      queryShopOrderDeliverys({
        pageNo,
        pageSize,
        orderby: 'createTime',
        sort: 'desc',
