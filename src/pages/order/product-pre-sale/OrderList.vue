  ...
  <div class="order-list">
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <div class="table-text">
            <p>下单用户：{{scope.row.memberPhone}}</p>
            <p>收货人：{{scope.row.orderReceiver}}</p>
            <p>收货电话：{{scope.row.contactInformation}}</p>
          </div>
        </template>
      </el-table-column>
      <el-table-column
      ...
      >
        <template slot-scope="scope">
          <div class="table-text">
            <p>自提点名称：{{scope.row.locationName}}</p>
            <p>自提点地址：{{scope.row.locationAddress}}</p>
          </div>
        </template>
      </el-table-column>
      <el-table-column
      ...
      >
        <template slot-scope="scope">
          <div class="table-text">
            ...
            <p>优惠金额：{{scope.row.totalDiscountPrice | money}}</p>
...
export default {
  ...
  methods: {
    handleEditOrder(index, row) {
      this.$router.push('productPreSaleDetail?orderNum=' + row.orderNum)
    },
