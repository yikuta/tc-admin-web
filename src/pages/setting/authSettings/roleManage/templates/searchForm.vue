 ...
 * @LastEditTime: 2020-09-15 15:27:52
 * @LastEditors: Joker
-->
<template>
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="6">
          <el-form-item label="角色状态">
            <el-select v-model="form.enable" placeholder="请选择角色状态">
        ...
        <el-col :span="12">
          <el-row type="flex" justify="end" class="search-btn">
            ...
            <el-button type="primary" icon="el-icon-plus" size="mini" v-np="'ACCOUNT_ROLE_ADD'" @click="handleChange('add')">添加角色</el-button>
          </el-row>
        </el-col>
      </el-row>
    </el-form>
