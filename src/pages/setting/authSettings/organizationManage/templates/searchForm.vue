 ...
 * @LastEditTime: 2020-09-15 15:18:35
 * @LastEditors: Joker
-->
<template>
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="6">
          <el-form-item label="部门状态">
            <el-select v-model="form.enable" placeholder="请选择部门状态">
        ...
        <el-col :span="12">
          <el-row type="flex" justify="end" class="search-btn">
            ...
            <el-button type="primary" icon="el-icon-plus" size="mini" v-np="'ACCOUNT_DEPT_ADD'" @click="handleChange('add')">添加部门</el-button>
          </el-row>
        </el-col>
      </el-row>
    </el-form>
