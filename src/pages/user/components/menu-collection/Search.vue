<template>
  <div class="wrapper">
    <el-form class="form" ref="form" :model="form" label-width="120px" inline size="small">
      <el-form-item label="菜谱名称" prop="cookbookName.value">
        <el-input v-model="form.cookbookName.value" clearable placeholder="菜谱名称"></el-input>
      </el-form-item>
...
export default {
  ...
  data() {
    return {
      form: {
        cookbookName: { value: '', name: 'cookbookName', matchType: MatchType.CONTAIN, type: DataType.STRING },
