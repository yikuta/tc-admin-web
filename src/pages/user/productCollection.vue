<template>
  <div class="wrapper">
    ...
    <content-area contentTitle="商品收藏列表">
...
<script>
import { Common, ProductCollection } from './components'
import Pagination from '@/components/Pagination'
import { fetchProductCollectList } from '@/api/user'
import searchTool from '@/utils/searchTool'
export default {
  name: 'productCollection',
  components: { ...Common, ...ProductCollection, Pagination },
  data() {
    return {
      tableData: {
        pageSize: 20,
