<template>
  <div class="app-container">
    <el-form class="form" ref="form" :model="form" :rules="rules" label-width="100px">
      ...
      <custom-detail-module ref="detailHeader" :businessNo="1" :isShowCommon="true"></custom-detail-module>
      <el-row class="title-main">详情底部</el-row>
      <custom-detail-module ref="detailBottom" :businessNo="1" :isShowCommon="true"></custom-detail-module>
    </el-form>
  </div>
</template>
