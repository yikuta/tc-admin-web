<template>
  <div class="app-container">
    <el-form class="form" ref="form" size="mini" :model="form" :rules="rules" label-width="80px">
      ...
      <el-form-item label="展示分类" class="required-form-item">
        ...
        />
        <el-button type="primary" @click="handleAddCategory" :disabled="!currentCategoryPath.length">添加</el-button>
      </el-form-item>

      <el-form-item v-if="form.categoryList.length">
        <div v-for="(item,idx) of form.categoriesList" :key="Date.now()+'-'+idx">
      ...
      <el-form-item label="套餐类型" prop="packageType">
        <el-radio-group v-model="form.packageType">
          ...
          <el-radio :label="1" disabled>自由组合套餐</el-radio>
        </el-radio-group>
        <el-alert
