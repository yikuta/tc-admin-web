  ...
  <div class="wrapper">
    ...
    <div class="goods-list">
      <el-card class="goods-item" v-if="mainGood.commodityId" @click="handleAddMainGood">
        ...
        <!-- <span class="goods-price">{{mainGood.costPrice}}</span> -->
        <span>{{mainGood['marketPrice']?mainGood['marketPrice']:mainGood.minMarketPrice^mainGood.maxMarketPrice?`￥${Number(mainGood.minMarketPrice).toFixed(2)}-￥${Number(mainGood.maxMarketPrice).toFixed(2)}`:`￥${Number(mainGood.minMarketPrice).toFixed(2)}`}}</span>
      </el-card>
    ...
    <div class="goods-list">
      <el-card class="goods-item" v-for="(item, index) in mealGoods" :key="item.commodityId">
        ...
        <!-- <span class="goods-price">{{item.costPrice}}</span> -->
        <span>{{item['marketPrice']?item['marketPrice']:item.minMarketPrice^item.maxMarketPrice?`￥${Number(item.minMarketPrice).toFixed(2)}-${Number(item.maxMarketPrice).toFixed(2)}`:`￥${Number(item.minMarketPrice).toFixed(2)}`}}</span>
      </el-card>
