<template>
  ...
  >
    ...
    <el-form :model="form" :rules="rules" size="small" ref="form" label-width="80px" style="margin-top: 14px">
      <el-form-item label="搭配数量" prop="quantity">
        <el-input   @input="handleInputInteger" v-model="form.quantity" autocomplete="off" placeholder="请填写搭配数量" />
      </el-form-item>
    </el-form>
      ...
      return {
        ...
        rules: {
          quantity: [
            ...
            { pattern: /^(([1-9]\d{0,3}))$/, message: '请输入1万以内的整数，不包含1万', trigger: 'blur' }
          ]
        }
      }
    },
